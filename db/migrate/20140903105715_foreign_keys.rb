class ForeignKeys < ActiveRecord::Migration
  def change
    ...
    add_foreign_key(:access_rights, :inventory_pools)
    add_foreign_key(:accessories, :models)
    add_foreign_key(:attachments, :models)
    ...
    add_foreign_key(:contract_lines, :contracts)
    ...
    add_foreign_key(:database_authentications, :users)
    add_foreign_key(:groups, :inventory_pools)
    add_foreign_key(:histories, :users)
    add_foreign_key(:holidays, :inventory_pools)
    ...
    add_foreign_key(:model_group_links, :model_groups, column: 'ancestor_id')
    add_foreign_key(:model_group_links, :model_groups, column: 'descendant_id')
    add_foreign_key(:model_links, :model_groups)
    add_foreign_key(:model_links, :models)
    add_foreign_key(:notifications, :users)
    add_foreign_key(:options, :inventory_pools)
    add_foreign_key(:partitions, :models)
    add_foreign_key(:partitions, :inventory_pools)
    add_foreign_key(:partitions, :groups)
    add_foreign_key(:properties, :models)
    add_foreign_key(:users, :users, column: 'delegator_user_id')
    add_foreign_key(:users, :authentication_systems)
    add_foreign_key(:users, :languages)
    add_foreign_key(:workdays, :inventory_pools)
